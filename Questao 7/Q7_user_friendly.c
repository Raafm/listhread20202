// USER FRINEDLY VERSION
/*
    Esta versao do codigo e para mostrar de modo mais claro o que o codigo faz. 
    Por isso a sua eficiencia reduz consideravelmente com as funcoes sleep() e printf() adicionadas para 
    que seja , de certo modo, possivel ver as operacoes durante a execucao.
*/
...
void* sort(void*arg){
    ...
    printf("Ordenando [%d, %d]: ",l,r);
    print(vetor,l,r);
    int m = (l+r)/2;

    printf("particionando:  [%d, %d] em: [%d, %d] e [%d, %d]\n",l,r,l,m,m,r);
